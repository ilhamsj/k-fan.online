            ...
            <div class="row h-100-kfan align-items-center mb-4 justify-content-center">
                ...
                <div class="col-6 col-md-3 mb-4 align-self-start berita-duka">
                    <div class="card border-0">
                        <img class="card-img-top img-fluid rounded" src="{{ preg_match('/jpg|png|jpeg|gif/', $item->foto) ? $item->foto : 'https://i.ibb.co/Wt7rX7K/RDJ-Tony-Stark-min-1.jpg' }}" alt="" srcset="">
